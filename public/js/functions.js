...
if ($(".nav-dropdown").length) {
  ...
  // Dropdown Toggle Click Menu Mobile 

  var navLinkDToggle = $(".nldt");

  navLinkDToggle.each(function() {
  var $this = $(this);
  var navDropdown = $this.parent(".nav-item").children(".nav-dropdown");
  var navDropdownToggle = $this.parent(".nav-item").children(".nav-dropdown-toggle");
  $this.on("click", function(e) {
    if (navDropdownToggle.hasClass("active")) {
      navDropdownToggle.removeClass("active");
      navDropdown.removeClass("show");
    }else {
      navDropdownToggle.addClass("active");
      navDropdown.addClass("show");
    }
    e.preventDefault();
    });
...
$(".countdown").each(function() {
  ...
  $(this).countdown(finalDate, function(event) {
    $(this).html(event.strftime(''
      + '<div><h2 class="font-weight-light margin-0">%D</h2><h6 class="font-weight-normal font-small uppercase margin-0">Días</h6></div>'
      + '<div><h2 class="font-weight-light margin-0">%H</h2><h6 class="font-weight-normal font-small uppercase margin-0">Horas</h6></div>'
      + '<div><h2 class="font-weight-light margin-0">%M</h2><h6 class="font-weight-normal font-small uppercase margin-0">Minutos</h6></div>'
      + '<div><h2 class="font-weight-light margin-0">%S</h2><h6 class="font-weight-normal font-small uppercase margin-0">Segundos</h6></div>'));
  });
});
...
$("#contactform").on("submit", function(e) {
  ...
  if (telephone === "") {
    $("#telephone").addClass("error-color");
  }
  if (message === "") {
...
$("#aereosform").on("submit", function(e) {
  var name = $("#name").val();
  var email = $("#email").val();
  ...
  if (message === "") {
    ...
    $.ajax({
      url:"assets/php/aereos-form.php",
      data:$(this).serialize(),
      type:"POST",
      success:function(data){
        $("#success").addClass("show-result"); //=== Show Success Message==
        $("#aereosform").each(function(){
          this.reset();
        });
      },
      error:function(data){
    ...
    var forms = $("#aereosform input, #aereosform textarea");
    forms.removeClass("error-color");
  }
...
$("#sinaereosform").on("submit", function(e) {
  var name = $("#name").val();
  var email = $("#email").val();
  var paquete = $("#paquete").val();
  var telephone = $("#telephone").val();
  ...
  if (message === "") {
    ...
    $.ajax({
      url:"assets/php/sinaereos-form.php",
      data:$(this).serialize(),
      type:"POST",
      success:function(data){
        $("#success").addClass("show-result"); //=== Show Success Message==
        $("#sinaereosform").each(function(){
          this.reset();
        });
      },
      error:function(data){
    ...
    var forms = $("#sinaereosform input, #sinaereosform textarea");
    forms.removeClass("error-color");
  }
...
/*===============================================
  8vos Final con Aereos Form D)
===============================================*/

$("#finalaereosform").on("submit", function(e) {
  var name = $("#name").val();
  var email = $("#email").val();
  var paquete = $("#paquete").val();
  var telephone = $("#telephone").val();
  ...
  if (message === "") {
    ...
    $.ajax({
      url:"assets/php/finalaereos-form.php",
      data:$(this).serialize(),
      type:"POST",
      success:function(data){
        $("#success").addClass("show-result"); //=== Show Success Message==
        $("#finalaereosform").each(function(){
          this.reset();
        });
      },
      error:function(data){
    ...
    var forms = $("#finalaereosform input, #finalaereosform textarea");
    forms.removeClass("error-color");
  }
...
/*===============================================
  8vos Final sin Aereos Form E)
===============================================*/

$("#finalsinaereosform").on("submit", function(e) {
  var name = $("#name").val();
  var email = $("#email").val();
  var paquete = $("#paquete").val();
  var telephone = $("#telephone").val();
  ...
  if (message === "") {
    ...
    $.ajax({
      url:"assets/php/finalsinaereos-form.php",
      data:$(this).serialize(),
      type:"POST",
      success:function(data){
        $("#success").addClass("show-result"); //=== Show Success Message==
        $("#finalsinaereosform").each(function(){
          this.reset();
        });
      },
      error:function(data){
    ...
    var forms = $("#finalsinaereosform input, #finalsinaereosform textarea");
    forms.removeClass("error-color");
  }
...
/*===============================================
  Grupos + 8vos Final con Aereos Form F)
===============================================*/

$("#grupos8vos-aereos").on("submit", function(e) {
  var name = $("#name").val();
  var email = $("#email").val();
  var paquete = $("#paquete").val();
  var telephone = $("#telephone").val();
  ...
  if (message === "") {
    ...
    $.ajax({
      url:"assets/php/grupo8vos-aereos.php",
      data:$(this).serialize(),
      type:"POST",
      success:function(data){
        $("#success").addClass("show-result"); //=== Show Success Message==
        $("#grupos8vos-aereos").each(function(){
          this.reset();
        });
      },
      error:function(data){
    ...
    var forms = $("#grupos8vos-aereos input, #grupos8vos-aereos textarea");
    forms.removeClass("error-color");
  }
...
/*===============================================
  Grupos + 8vos Final sin Aereos Form G)
===============================================*/

$("#grupos8vos-sinaereos").on("submit", function(e) {
  var name = $("#name").val();
  var email = $("#email").val();
  var paquete = $("#paquete").val();
  var telephone = $("#telephone").val();
  ...
  if (message === "") {
    ...
    $.ajax({
      url:"assets/php/grupo8vos-sinaereos.php",
      data:$(this).serialize(),
      type:"POST",
      success:function(data){
        $("#success").addClass("show-result"); //=== Show Success Message==
        $("#grupos8vos-sinaereos").each(function(){
          this.reset();
        });
      },
      error:function(data){
    ...
    var forms = $("#grupos8vos-sinaereos input, #grupos8vos-sinaereos textarea");
    forms.removeClass("error-color");
  }
