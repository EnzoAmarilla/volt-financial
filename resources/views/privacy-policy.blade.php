...
@section('title') Privacy Policy | Volt Solar Energy @endsection
...
@include('components.sections.banner', [
    ...
    'subtitulo' => 'Volt Solar Energy',
    'imagen' => 'images/Main/1-help.avif', 
    // other necessary attributes
])
<div class="container section-sm">
{{-- Introduction and Overview --}}
@include('components.sections.text-section', [
    'title' => 'Overview',
...
<ul>
    <li><b>Company</b> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Volt Solar Energy.</li>
...
@include('components.sections.text-section', [
    ...
    'text' => '<ul><li><b>With Service Providers:</b> We may share Your personal information with Service Providers to monitor and analyze the use of our Service, to contact You.</li>
...
<li><b>With Affiliates: We</b> may share Your information with Our affiliates, in which case we will require those affiliates to honor this Privacy Policy. Affiliates include Our parent company and any other subsidiaries, joint venture partners or other companies that We control or that are under common control with Us.</li>
...
@include('components.sections.text-section', [
    ...
    'text' => 'The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet...'
    // other necessary attributes
])
...
@include('components.sections.text-section', [
    'title' => 'Contact Us',
    'text' => 'If you have any questions about this Privacy Policy, You can contact us via email at <a href="mailto:ab@voltsolarenergy.com" style="color:black;">ab@voltsolarenergy.com</a>'
    // other necessary attributes
])
</div>
<br/>
